...
![](https://cdn.jsdelivr.net/gh/raisew/gallery/wedoc/202405140939553.png)
...
![](https://cdn.jsdelivr.net/gh/raisew/gallery/wedoc/202405140939718.gif)
...
```jsx
/** * 模拟发货-内测版 * @description 在DEV环境下使用，仅在订单状态为待发货时，可模拟发货，调用后订单状态修改为待收货，包含模拟物流。 * @param id 订单id */ export const getMemberOrderConsignmentByIdAPI = (id: string) => {
...
![](https://cdn.jsdelivr.net/gh/raisew/gallery/wedoc/202405140940083.png)
