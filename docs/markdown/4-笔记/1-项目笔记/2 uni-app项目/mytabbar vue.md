...
```jsx
<template>
	<u-tabbar v-model="pageData.current" :list="pageData.list" :mid-button="false" :border-top="false"
		active-color="rgb(19, 141, 179)" inactive-color="#fff" :hide-tab-bar="true"></u-tabbar>
</template>
...
<script setup>
	...
	const pageData = reactive({
		list: [{
				iconPath: proxy.Pub.getThemeImg('tabbar/icon_home.png'),
				selectedIconPath: proxy.Pub.getThemeImg('tabbar/icon_home_active.png'),
				text: '首页',
				customIcon: false,
				pagePath: '/pages/index/index',
			},
			{
				iconPath: proxy.Pub.getThemeImg('tabbar/icon_quotes.png'),
				selectedIconPath: proxy.Pub.getThemeImg('tabbar/icon_quotes_active.png'),
				text: '行情',
				customIcon: false,
				pagePath: '/pages/quotes/quotes',
			},
			{
				iconPath: proxy.Pub.getThemeImg('tabbar/icon_optional.png'),
				selectedIconPath: proxy.Pub.getThemeImg('tabbar/icon_optional_active.png'),
				text: '自选',
				customIcon: false,
				pagePath: '/pages/optional/optional',
			},
			{
				iconPath: proxy.Pub.getThemeImg('tabbar/icon_mine.png'),
				selectedIconPath: proxy.Pub.getThemeImg('tabbar/icon_mine_active.png'),
				text: '我的',
				customIcon: false,
...
<template>
	<view v-if="show" class="u-tabbar" @touchmove.stop.prevent="() => {}">
		...
		<view class="u-fixed-placeholder safe-area-inset-bottom" :style="{
				height: `calc(${$u.addUnit(height)} + ${midButton?'48rpx':'0px'})`
			}"></view>
	</view>
</template>
...
<script>
	export default {
		...
		mounted() {
			...
			console.log(this.$u.addUnit(this.height));
		},
		methods: {
