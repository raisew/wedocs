...
import "./Content.2nvBeP-A.js";
import { Solar, Lunar, LunarMonth, SolarMonth, HolidayUtil } from "lunar-javascript";
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "clock position-relative" }, _attrs))} data-v-ffb669bb><div class="hour" data-v-ffb669bb></div><div class="min" data-v-ffb669bb></div><div class="sec" data-v-ffb669bb></div><div class="position-absolute left-0 bottom-30 font-10 w-100 align-center" data-v-ffb669bb><p data-v-ffb669bb>${ssrInterpolate(nowTime.value)}</p><p data-v-ffb669bb>${ssrInterpolate(nowWeek.value)}</p></div></div>`);
    };
  }
};
...
const Clock = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-ffb669bb"]]);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _cssVars = { style: {
    "--6c93be2b": $props.mainColor,
    "--7c338024": $props.labelColor,
    "--787d3770": $props.mainFlipBackgroundColor,
    "--78956d23": $props.secondFlipColor,
    "--cf77f6d6": $props.secondFlipBackgroundColor
  } };
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "flip-clock" }, _attrs, _cssVars))} data-v-c81772c6><!--[-->`);
  ssrRenderList($setup.timeData, (data) => {
    _push(`<span class="flip-clock__piece"${ssrRenderAttr("id", data.elementId)} style="${ssrRenderStyle(data.show ? null : { display: "none" })}" data-v-c81772c6>`);
    if ($props.flipAnimation) {
      _push(`<div data-v-c81772c6><span class="flip-clock__card flip-card" style="${ssrRenderStyle($props.countdownSize ? `font-size:${$props.countdownSize}` : "")}" data-v-c81772c6><b class="flip-card__top" data-v-c81772c6>${ssrInterpolate($setup.twoDigits(data.current))}</b><b class="flip-card__bottom"${ssrRenderAttr("data-value", $setup.twoDigits(data.current))} data-v-c81772c6></b><b class="flip-card__back"${ssrRenderAttr("data-value", $setup.twoDigits(data.previous))} data-v-c81772c6></b><b class="flip-card__back-bottom"${ssrRenderAttr("data-value", $setup.twoDigits(data.previous))} data-v-c81772c6></b></span></div>`);
    } else {
      _push(`<div data-v-c81772c6><span class="no-animation__card" data-v-c81772c6>${ssrInterpolate($setup.twoDigits(data.current))}</span></div>`);
    }
    if ($props.showLabels) {
      _push(`<span class="flip-clock__slot" style="${ssrRenderStyle($props.labelSize ? `font-size:${$props.labelSize}` : "")}" data-v-c81772c6>${ssrInterpolate(data.label)}</span>`);
    } else {
      _push(`<!---->`);
    }
    _push(`</span>`);
...
const Countdown = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-c81772c6"]]);
const _sfc_main$3 = {
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "calendar-box" }, _attrs))} data-v-72cb1362><div class="calendar" data-v-72cb1362><div class="calendar-container" data-v-72cb1362><div class="bar" data-v-72cb1362><div data-v-72cb1362><input${ssrRenderAttr("value", state.year)} data-v-72cb1362>年 </div><div data-v-72cb1362><select data-v-72cb1362><!--[-->`);
      ssrRenderList(12, (i) => {
        _push(`<option${ssrRenderAttr("value", i)} data-v-72cb1362>${ssrInterpolate(i)}月</option>`);
      });
      _push(`<!--]--></select></div><div data-v-72cb1362><select data-v-72cb1362><option value="0" data-v-72cb1362${ssrIncludeBooleanAttr(Array.isArray(state.holidayMonth) ? ssrLooseContain(state.holidayMonth, "0") : ssrLooseEqual(state.holidayMonth, "0")) ? " selected" : ""}>假期安排</option><!--[-->`);
      ssrRenderList(state.holidays, (h) => {
        _push(`<option${ssrRenderAttr("value", h.month)} data-v-72cb1362>${ssrInterpolate(h.name)}</option>`);
      });
      _push(`<!--]--></select></div><div data-v-72cb1362><div class="button" data-v-72cb1362>返回今天</div></div></div><ul class="head" data-v-72cb1362><!--[-->`);
      ssrRenderList(state.data.heads, (head) => {
        _push(`<li data-v-72cb1362>${ssrInterpolate(head)}</li>`);
      });
      _push(`<!--]--></ul><ul class="body" data-v-72cb1362><!--[-->`);
      ssrRenderList(state.data.weeks, (week) => {
        _push(`<li data-v-72cb1362><ol data-v-72cb1362><!--[-->`);
        ssrRenderList(week.days, (day) => {
          _push(`<li class="${ssrRenderClass({ today: day.isToday, selected: day.isSelected, other: day.month != state.month, rest: day.isRest, holiday: day.isHoliday })}" data-v-72cb1362><div class="inner" data-v-72cb1362><b data-v-72cb1362>${ssrInterpolate(day.day)}</b><i data-v-72cb1362>${ssrInterpolate(day.desc)}</i>`);
          if (day.isHoliday) {
            _push(`<u data-v-72cb1362>${ssrInterpolate(day.isRest ? "休" : "班")}</u>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></li>`);
      ...
      _push(`<!--]--></ul></div><div class="side" data-v-72cb1362><div class="ymd" data-v-72cb1362>${ssrInterpolate(state.selected.ymd)}</div><div class="day" data-v-72cb1362>${ssrInterpolate(state.selected.day)}</div><div class="lunar" data-v-72cb1362><div data-v-72cb1362>${ssrInterpolate(state.selected.lunarMonth)}月 ${ssrInterpolate(state.selected.lunarDay)}</div><div data-v-72cb1362>${ssrInterpolate(state.selected.yearGanZhi)}年 ${ssrInterpolate(state.selected.yearShengXiao)}</div><div data-v-72cb1362>${ssrInterpolate(state.selected.monthGanZhi)}月 ${ssrInterpolate(state.selected.dayGanZhi)}日</div></div><!--[-->`);
      ssrRenderList(state.selected.festivals, (f) => {
        _push(`<div class="festival" data-v-72cb1362>${ssrInterpolate(f)}</div>`);
      });
      _push(`<!--]--><div class="yiji" data-v-72cb1362><div class="yi" data-v-72cb1362><b data-v-72cb1362>宜</b><!--[-->`);
      ssrRenderList(state.selected.yi, (f) => {
        _push(`<div data-v-72cb1362>${ssrInterpolate(f)}</div>`);
      });
      _push(`<!--]--></div><div class="ji" data-v-72cb1362><b data-v-72cb1362>忌</b><!--[-->`);
...
const Calendar = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-72cb1362"]]);
